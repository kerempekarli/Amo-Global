...
export default function Hero() {
  return (
    <div className="bg-kahve relative max-w-[1920px] h-[320px] lg:h-[720px] overflow-hidden">
      <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 lg:bottom-1/4 lg:left-1/3 leading-snug  xl:bottom-[113px] xl:left-[330px] text-4xl sm:text-5xl lg:text-7xl xl:text-5xl text-center xl:text-left text-white xl:leading-[50px]">
